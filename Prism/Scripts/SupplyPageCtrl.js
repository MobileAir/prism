...
function SalesCartCtrl($scope) {
    ...
    $scope.setPreviousDebit = function (balance) {
        $scope.previousDebit = balance;
    };

    $scope.getGrandTotal = function () {
        return $scope.previousDebit + $scope.getSumOfProductsInNum();
    };

    $scope.getPreviousDebit = function () {
        return $scope.previousDebit;
    }
